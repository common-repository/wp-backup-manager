...
class UpdraftPlus_BackupModule_updraftvault extends UpdraftPlus_BackupModule_s3 {
	...
	public function get_config() {
		...
		if (!is_array($opts) || empty($opts['token']) || empty($opts['email'])) {
			// Not connected
			$updraftplus->log("WP Backup Manager: this site has not been connected - check your settings");
		...
		$updraftplus->log("WP Backup Manager: requesting access details (sid=$site_id, email=".$opts['email'].")");
