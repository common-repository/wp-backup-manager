...
// 				'ourkeys' => $this->list_our_keys($our_keys),
					...
					<tr class="updraft_debugrow"> 
						...
						<td style="width:80%;"> 
							<label> 
								...
								WP Backup Manager (<?php _e('i.e. you have an account there', 'updraftplus') ?>) 
							</label> 
							<br> 
							<label> 
								<input type="radio" name="updraftcentral_mothership" id="updraftcentral_mothership_other"> 
								<?php _e('Other (please specify - i.e. the site where you have installed an WP Backup Manager Central dashboard)', 'updraftplus') ?>: 
							</label> 
							<br> 
	...
	?>
		<div class="advanced_tools updraft_central">
			<h3><?php _e('WP Backup Manager (Remote Control)', 'updraftplus'); ?></h3>
			<p>
				<?php echo __('WP Backup Manager enables control of your WordPress sites (including management of backups and updates) from a central dashboard.', 'updraftplus').' '; ?>
			</p>
			<div id="updraftcentral_keys">
