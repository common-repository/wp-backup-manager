...
<div class="advanced_tools export_settings">
	...
	<p>
		<?php printf(__('Here, you can export your WP Backup Manager settings (%s), either for using on another site, or to keep as a backup. This tool will export what is currently in the settings tab.', 'updraftplus'), '<strong>'.__('including any passwords', 'updraftplus').'</strong>');?>
	</p>
